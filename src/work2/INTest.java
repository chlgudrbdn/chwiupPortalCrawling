...
//        driver.findElement(By.id("svc.kin")).click();    //지식인 클릭
        driver.findElement(By.id("gnb_login_layer")).click();  //NAVER로그인 클릭
 
        driver.findElement(By.id("id")).sendKeys("apxkfchlgudr");  //ID
        driver.findElement(By.id("pw")).sendKeys("m1273910!@"); //비번
        driver.findElement(By.cssSelector("#frmNIDLogin > fieldset > input")).click(); //로그인 버튼 클릭
        driver.findElement(By.className("btn_cancel")).click(); //로그인 버튼 클릭
